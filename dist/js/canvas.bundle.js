...
var limitPlayer = canvas.width / 1.5;
var normalGameSpeed = 5;
var gravity = 0.5;
...
function animationLoop() {
  ...
  console.log(scrollOffset); // Check collission between 2 rectangular objects with Rect Collission, first in y, then in x
